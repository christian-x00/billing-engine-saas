...
// --- IMPORTS FOR DASHBOARD (Logged In) ---
import DashboardLayout from '@/components/DashboardLayout'
import { 
  Activity, CreditCard, TrendingUp, Users, 
  ArrowUpRight, Copy, Check, Terminal, Code 
} from 'lucide-react'
import { 
  AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer 
} from 'recharts'

// --- IMPORTS FOR LANDING PAGE (Public) ---
...
// ==========================================
// 2. DASHBOARD VIEW (Executive Dashboard)
// ==========================================
...
// ==========================================
// 3. MAIN CONTROLLER (The Switcher)
// ==========================================
export default function Home() {
    ...
    if (isAuthenticated === null) return null // Loading state (could add a spinner here)
